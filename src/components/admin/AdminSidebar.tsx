...
// // //   { href: '/books', label: 'Kelola Buku', icon: BookOpen },
// // //   { href: '/upload', label: 'Upload Buku', icon: Upload },
// // // ];
...
// // //     <aside
// // //       className={cn(
// // //         'fixed top-0 left-0 h-screen w-56 flex flex-col border-r z-40 transition-colors duration-300',
// // //         dark ? 'bg-navy-900 border-white/10' : 'bg-white border-parchment-darker'
// // //       )}
// // //     >
// // //       {/* Brand */}
...
// // //           </div>
// // //           <div>
// // //             <p className="font-serif font-black text-sm" style={{ color: 'var(--text)' }}>
// // //               Pustara
// // //             </p>
...
// // //                 active
// // //                   ? 'bg-gold text-navy-900 font-semibold shadow-sm'
// // //                   : dark
...
// // //             dark ? 'text-slate-400 hover:text-white hover:bg-white/8' : 'text-slate-600 hover:text-navy-900 hover:bg-slate-100'
// // //           )}
// // //         >
...
// // //           className={cn(
// // //             'flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-medium transition-all w-full text-left text-red-500 hover:bg-red-500/10'
// // //           )}
// // //         >
...
//   { href: '/admin/upload', label: 'Upload Buku', icon: Upload },
// ];
...
//   // Token styling ngikutin Navbar lu
//   const txtSecondary = isLight ? 'text-navy-500' : 'text-white/60';
//   const hoverBg = isLight ? 'hover:bg-navy-800/10' : 'hover:bg-white/10';
//   const hoverTxt = isLight ? 'hover:text-navy-900' : 'hover:text-white';
  
//   // Efek tombol pas lagi aktif
//   const activeClasses = isLight
//     ? 'text-navy-900 font-bold bg-navy-800/10 shadow-[inset_0_0_0_1px_rgba(15,23,42,0.08)]'
//     : 'bg-white/15 text-white font-bold shadow-[inset_0_0_0_1px_rgba(255,255,255,0.1)]';
...
//   return (
//     <aside className={cn(
//       "fixed top-0 left-0 h-screen w-56 border-r flex flex-col z-40 transition-colors duration-300",
//       isLight 
//         ? "bg-[#FAFAF8] border-slate-200" 
//         : "bg-[#0d1829] border-white/10"
//     )}>
//       {/* Header & Logo */}
//       <div className="h-16 flex items-center px-6 border-b" style={{ borderColor: isLight ? 'rgba(200,194,184,0.55)' : 'rgba(255,255,255,0.1)' }}>
//         <Link href="/" className="flex items-center gap-2">
//           <Logo className="w-8 h-8" />
//           <Wordmark isLight={isLight} className="h-4 w-auto" />
//         </Link>
//       </div>

//       {/* Main Navigation */}
//       <nav className="flex-1 px-3 py-6 space-y-1">
//         <div className="px-3 mb-3 text-xs font-bold tracking-wider text-gold uppercase">
//           Admin Menu
//         </div>
//         {NAV.map(({ href, label, icon: Icon }) => {
//           // Highlight otomatis nyala kalau URL saat ini cocok
...
//       <div className="p-4 border-t" style={{ borderColor: isLight ? 'rgba(200,194,184,0.55)' : 'rgba(255,255,255,0.1)' }}>
//         <button
//           onClick={handleLogout}
//           className={cn(
//             "flex items-center gap-3 px-3 py-2.5 w-full rounded-xl text-sm font-medium transition-all text-red-500",

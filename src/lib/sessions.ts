 ...
 */
async function handleSessionRevoked(showToast?: (msg: string, type: string) => void) {
 ...
 */
export async function getSessions(showToast?: (msg: string, type: string) => void): Promise<Session[]> {
  try {
